...
## Sprint 1 (Week 22/9–28/9)
- Set up GitHub repository with GitFlow branches (`master`, `develop`, `release`).  
- Define and publish a team Code of Conduct.  
- Configure Maven to build a self-contained JAR.  

## Sprint 2 (Week 29/9–3/10) `Code Review 1`
- Create Dockerfile for containerised setup.  
- Configure GitHub Actions to run build automatically.  
- Ensure project builds and first release is created on GitHub.  

---

## Sprint 3 (Week 6/10–10/10)
- Define full use cases and create a use case diagram.  
